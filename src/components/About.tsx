  ...
  return (
    <section id="about" aria-labelledby="about-heading">
      ...
      <p>
        ...
        and innovative methods, our lab works directly with the Bafuliiru community 
        to create comprehensive educational resources in their native language.
      </p>
      <p>
        Our lab's work demonstrates that <strong>innovative approaches</strong>, when paired with 
        ...
        All platforms and content have been <strong>created by Ayivugwe Kabemba Mukome</strong>, ensuring authentic cultural and linguistic preservation through native speaker expertise. This approach 
