export default function Navigation() {
  return (
    <nav className="nav" role="navigation" aria-label="Main navigation">
      ...
      <a href="#publications" aria-label="Publications and Documentation">Publications</a>
      <a href="#team" aria-label="Research Team and Leadership">Team</a>
      <a href="#contact" aria-label="Contact and Collaboration">Contact</a>
    </nav>
  )
}
