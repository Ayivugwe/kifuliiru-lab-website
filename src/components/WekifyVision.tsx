export default function WekifyVision() {
  return (
    <section id="wekify-vision">
      <h2>Wekify LLC Vision</h2>
          <p>
            ...
            the Kifuliiru language. Each endangered language receives its own dedicated language laboratory research facility, ensuring 
